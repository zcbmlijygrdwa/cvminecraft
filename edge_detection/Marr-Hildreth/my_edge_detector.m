function imgs = my_edge_detector(impath) 
...
% img_conv_3 = my_conv2(img,log3, 'same');
% img_conv_6 = my_conv2(img,log6, 'same');
% img_conv_12 = my_conv2(img,log12, 'same');
% img_conv_24 = my_conv2(img,log24, 'same');
% img_conv_48 = my_conv2(img,log48, 'same');
