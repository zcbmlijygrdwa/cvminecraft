...
int main(int argc, char** argv)
{
    ...
    vector<Point3d> vec_points_3d1 = matToVec3(points_3d);

    for(uint i = 0 ; i < vec_points_3d1.size() ; i++)
    {
        cout<<"vec_points_3d1["<<i<<"] = "<<vec_points_3d1[i]<<endl;
    }

    cout<<"-------------------------"<<endl;
    vector<Point3d> vec_points_3d1_transformed = matToVec3(points_3d_transformed);
    for(uint i = 0 ; i < vec_points_3d1.size() ; i++)
    {
        cout<<"vec_points_3d1_transformed["<<i<<"] = "<<vec_points_3d1_transformed[i]<<endl;
    }
    ...
    cout<<"-------------------------"<<endl;
    //start to do solve 3d3d pose
    Mat rvec;
    Mat tvec;


    Solve3D3DCeres solve3d3dceres;
    solve3d3dceres.init();
    cout<<"vec_points_3d1.size() = "<<vec_points_3d1.size()<<endl;
    cout<<"vec_points_3d1_transformed.size() = "<<vec_points_3d1_transformed.size()<<endl;
    solve3d3dceres.setInputs(vec_points_3d1,vec_points_3d1_transformed);
    solve3d3dceres.optimize(&rvec,&tvec,false);
    cout<<"//*****************************************"<<endl;
